...
<!--==========================
    ...
    <section id="more-features" class="section-bg">
      <div class="container">
        ...
        <div class="row">
        <form style="width:100%;" id="frmKeranjang" method="get" action="/hasil/keranjang/simpan">
        <div class="row" style="width:100%;">
              <div class="box wow fadeInLeft" style="width:100%;">
              <a href="/hasil" class="btn btn-info">Tambah Belanjaan</a>
              <input id="btnbayar" disabled type="submit" value="Lakukan Pembayaran" class="btn btn-success">
                ...
                @if($idhasil>0)
                @for ($i = 0; $i < count($idhasil); $i++)
                
                        <tr class="btnrow" for="cb{{$i}}">
                            <td class="kolkeranjang1">
                            <div style="" class="checkbx custom-control custom-checkbox">
                                <input unchecked=false name="indexhasilternak[]" type="checkbox" value="{{$i}}" onclick="valcheck({{$i}})" id="defaultUnchecked{{$i}}"  class="custom-control-input indexhasilternak">
                                <label class="custom-control-label" for="defaultUnchecked{{$i}}"> </label>
                            </div>
                            </td>
                            <td class="kolkeranjang2">
                                <h7 class="title" style="font-weight:700;">{{$nama_hasil[$i]}}</h7>
                            </td>
